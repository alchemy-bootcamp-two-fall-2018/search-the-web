export default {
    getNews(searchTerm = '') {
      ...
      const apiKey = process.env.VUE_APP_API_KEY;
        // return fetch(`https://newsapi.org/v2/everything&apiKey=9c1283752a154aa9a9d72d01b0d8a83a')
        // return fetch(`https://newsapi.org/v2/everything&apiKey=${apiKey}&q=${encodeURIComponent(searchTerm)}`)
        // return fetch(`https://newsapi.org/v2/everything?q=${encodeURIComponent(searchTerm)}&apiKey=${apiKey}`)
        return fetch(`https://newsapi.org/v2/top-headlines?country=us&apiKey=${apiKey}&q=${encodeURIComponent(searchTerm)}`)
        // return fetch(`https://newsapi.org/v2/everything?q=${encodeURIComponent(searchTerm)}&apiKey=9c1283752a154aa9a9d72d01b0d8a83a`) 
